...
class WatchGvAdapter(context: Context, listShow: List<Show>, val parentInterface:WatchListFragment.WatchListFragInterface) : ArrayAdapter<Show>(context, 0, listShow) {
